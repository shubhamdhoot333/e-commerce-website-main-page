			...
			<!--1row-->				
							<div class="row">
								<div class=" col-lg-6 text-center">
									<br>
									<i class="fa fa-user-circle" style="font-size:90px "></i><br><br>
									<table class="table table-striped">
										  <tbody>
										     <tr>
											       <td>Name:</th>
													<td>Mr.Natwar Maheshwari </td>
											</tr>
											<tr>
													<td>Company:</td>
													<td>Shree balaji art and craft</td>
											</tr>
											<tr>
													<td>Position:</td>
													<td>Company owner & manager </td>
											</tr>
											<tr>
													<td>Exprience:</td>
													<td>+17 year</td>
								...
								<div class=" col-lg-6 text-center">
									...
									<table class="table table-striped">
										  <tbody>
										     <tr>
											       <td>Name:</th>
													<td>Mr.Ganesh Maheshwari </td>
											</tr>
											<tr>
													<td>Company:</td>
													<td>Narayan art and craft</td>
											</tr>
											<tr>
													<td>Position:</td>
													<td>Company owner & manager </td>
