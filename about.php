...
<body>
	...
	<!--container-->					
		...
		<!--1row-->				
							<div class="row">
								<div class="col-lg-12 text-center">
									<b><font face="segoe script" size="7px"> India's best Furniture store</font></b>
									<br><h5 class="h5"><u>we ensuue to fulfill customer requirement</u></h5>
								</div>
							</div>
		<!--2row-->		
							<br>
							<div class="row">
								<div class="col-lg-12 text-center">
									<h5 class="h5">welcome to&nbsp<u><?php echo "$Username";?></u></h5>
								</div>
							</div>
						</div>
		...
		<!--3row-->		<br>
						<div class="row">
						<div class="col-lg-12 text-center">
							<h6 class="h6"> 1.We are leading india handicraft manufacture.We are basically in jodhpur india.we come with a wide area of highly beautiful handicraft in india.
						<br><br>
							2.Our highly skilled craftemen are expert in crafting structure upon wood glass, metal,paper and other.our handicraft in jodhpur are loved,because of finishing and beauty associated.
							<br><br>
							3.We are basically deal with woods,craft  and glass related wooden item. Made by highly skilled and professional team of artisans
							</h6>
						</div>
						</div>
		<!--4row-->		<br>
						<div class="row">
						<div class="col-lg-12 text-center">
							<h4 class="h4"><u>Why Choose Us</u></h4>
							<br><h6 class="h6">We understand that furniture no longer attributes for “one size fits all”, so we offer an endless array of customization options to make sure the furniture
							is perfect for your home space! Crafting each unit with premium quality & best solid wood we ensure a lasting durability.We offer furniture for every budget!</h6>
						</div>
						</div>
		<!--5row-->		<br>
						<div class="row">
						<div class="col-lg-12 text-left">
							<h5 class="h5"><u>Some of feature allowing to appear different form other </u></h5>
							<h6 class="h6">
							1. Team of expert snd professsional artisans.<br>
							2. Strong infrastructure base.<br>
							3. Nice business network<br>
							4 Highly qualified product.<br>
