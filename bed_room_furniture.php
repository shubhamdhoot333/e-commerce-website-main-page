...
<head>
            ...
            <title>Bed Room Furniture</title>
			<!--link-->
...
<body>
		...
		<!--breadcrumb-->			
						<div aria-label="breadcrumb">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Bed Room furniture</li>
								</ol>
						</div>
						<div class="container">
		<!--1row-->
						...
						<b> <font size="5px" color="red" face="segoe script" > Shop by Bed Room furniture</font></b>
						</div>
						</div>
		...
		<!--2row-->		<br><br>	
						<div class="row">
							...
							<?php
							$result=mysqli_query($conn,"select * from beds");
							$row = mysqli_fetch_array($result);
										 $photo=$row['photo1'];
							?>
							<a  class="p-2" href="common.php?value1=bed & value2=beds">
							...
							<div class="col-lg-4 text-center">
							<?php
							$result=mysqli_query($conn,"select * from table1 where name='dressing table'");
							$row = mysqli_fetch_array($result);
										 $photo=$row['photo1'];
							?>
							<a  class="p-2" href="common.php?value1=dressing table & value2=table1">
							...
							<div class="col-lg-4 text-center">
							<?php
							$result=mysqli_query($conn,"select * from storage where name='storage'");
							$row = mysqli_fetch_array($result);
										 $photo=$row['photo1'];
							?>
							<a  class="p-2" href="common.php?value1=storage & value2=storage">
							<img src="<?php echo $photo;?>" height="200px" width="200px"><br><br>
							<font color="black" size="4px">
								<b>Bedroom storage</b>
 							</font><br><br>
		...
		<!--3row--><br><br>
						<div class="row">
						<div class="col-lg-12 text-center">
						<b> <font size="5px" color="red" face="segoe script" > Shop by  kid Bed Room furniture</font></b>
						</div>
						</div>
		...
		<!--4row-->	<br>			
						<div class="row">
							<div class="col-lg-4 text-center">
							<?php
							$result=mysqli_query($conn,"select * from beds where name='kid bed'");
							$row = mysqli_fetch_array($result);
										 $photo=$row['photo1'];
							?>
							<a  class="p-2" href="common.php?value1=kid bed & value2=beds">
							<img src="<?php echo $photo;?>" height="200px" width="200px"><br><br>
							<font color="black" size="4px">
								<b>	kid bed </b>
 							</font><br><br>
							...
							<div class="col-lg-4 text-center">
															<?php
							$result=mysqli_query($conn,"select * from table1 where name='study table'");
							$row = mysqli_fetch_array($result);
										 $photo=$row['photo1'];
							?>
							<a  class="p-2" href="common.php?value1=study table & value2=table1">
							<img src="<?php echo $photo;?>" height="200px" width="200px"><br><br>
							<font color="black" size="4px">
								<b>Study table </b>
							...
							<div class="col-lg-4 text-center">
								<?php
							$result=mysqli_query($conn,"select * from chair where name='kid chair'");
							$row = mysqli_fetch_array($result);
										 $photo=$row['photo1'];
							?>
							<a  class="p-2" href="common.php?value1=kid chair & value2=chair">
							<img src="<?php echo $photo;?>" height="200px" width="200px"><br><br>
							<font color="black" size="4px">
								<b>	kids chair </b>
