...
<body>
		...
		<!--row-->			
					<div class="row">
						...
						<?php
						$result=mysqli_query($conn,"select * from notification where id='1' ");
						$row = mysqli_fetch_array($result);
						 $n1=$row['notification'];
						
						?>	
						<div class="card">
							<div class="card-body bg-light bg-primary">
							<font size='4px'>
						<?php  echo $n1;    ?>
							</font>
							</div>
	...
	<!--row-->		<br>	
					<div class="row">
						<div class="col-lg-12 text-center">
						<?php
						$result=mysqli_query($conn,"select * from notification where id='2' ");
						$row = mysqli_fetch_array($result);
						 $n2=$row['notification'];
