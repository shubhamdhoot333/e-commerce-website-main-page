...
<body>
	...
	<!--container-->
						...
						<div class="container">
							<?php
								$result=mysqli_query($conn,"select * from offertable where stage='active' ");
								...
								echo "<div class='card-body'>";
										 ...
										 $promo=$row['promo'];
										  echo "<font size='5px' face='segoe script' color='red' class='bg-dark'><b>";
										 echo "Offername&nbsp:&nbsp".$name;
										 echo "<br></font><br>";
										echo "<font size='5px' >";
										 echo $size."% Discount On Your Purchase";
										 echo "</font><br><br>";	
										 echo "<font size='4px' >";		
										 echo " Use Promo Code &nbsp:&nbsp&nbsp&nbsp".$promo;
										 echo "</font></u><br><br>";
										echo "<font size='4px' >";		
										 echo " *Limit of amount&nbsp:&nbsp&nbsp&nbsp".$amount;
										 echo "</font></b>";
