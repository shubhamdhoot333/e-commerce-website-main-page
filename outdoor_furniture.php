		...
		<!--breadcrumb-->			
						<div aria-label="breadcrumb">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Out door furniture</li>
								</ol>
						</div>
						<div class="container">
		<!--1row-->
						...
						<b> <font size="5px" color="red" face="segoe script" > Shop by Out Door furniture </font></b>
						</div>
						</div>
		...
		<!--3row-->		<br><br>	
						<div class="row">
							<div class="col-lg-4 text-center">
									<?php
							$result=mysqli_query($conn,"select * from otheritem where name='garden furniture'");
							$row = mysqli_fetch_array($result);
										 $photo=$row['photo1'];
							?>
							<a  class="p-2" href="common.php?value1=garden furniture & value2=otheritem">
							...
							<div class="col-lg-4 text-center">
									<?php
							$result=mysqli_query($conn,"select * from otheritem where name='balcony furniture'");
							$row = mysqli_fetch_array($result);
										 $photo=$row['photo1'];
							?>
							<a  class="p-2" href="common.php?value1=balcony furniture & value2=otheritem">
							<img src="<?php echo $photo;?>" height="200px" width="200px"><br><br>
							<font color="black" size="4px">
								<b>balcony  furniture
  </b>
							...
							<div class="col-lg-4 text-center">
						<?php
							$result=mysqli_query($conn,"select * from otheritem where name='wooden swing'");
							$row = mysqli_fetch_array($result);
										 $photo=$row['photo1'];
							?>
							<a  class="p-2" href="common.php?value1=wooden swing & value2=otheritem">
							<img src="<?php echo $photo;?>" height="200px" width="200px"><br><br>
							<font color="black" size="4px">
							<b>wooden swing
  </b>
