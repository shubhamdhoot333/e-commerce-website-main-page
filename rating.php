		...
		<!--1row-->	<br>
					<div class="row">
						<div class="col-lg-12 text-center">
							<font face="segoe script" color="red" size="5px"><u><b>You can Submit Your Product Story</b></u></font>
						</div>						
					</div>		
						<br>
					<div class="border">
						<form name="story" method="POST" action="rating.php" enctype="multipart/form-data">									
		<!--2row-->
						<div class="row">
									<div class="col-lg-4 text-center "></div>
									<div class="col-lg-4 text-center ">	
										<font size="4px"><label><b> Give Photo</b></label></font>
		...
		<!--3row-->		
						<div class="row">
							...
							<div class="col-lg-5 text-center ">
									<font size="4px"><label><b>Usernanme</b></label></font>
							...
							<div class="col-lg-5 text-center ">
								<font size="4px"><label><b>Area</b></label></font>
		...
		<!--4row-->
					<div class="row">
						...
						<div class="col-lg-6 text-center ">
								<font size="4px"><label><b>Story</b></label></font>
						<textarea class="form-control" rows="3" name="data" placeholder="product is really nice and beautiful"></textarea>
							<small>* 255 word</small>
						</div>
						<div class="col-lg-3 text-center ">
						</div>	
					</div>
