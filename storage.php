		...
		<!--breadcrumb-->			
						<div aria-label="breadcrumb">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page"> Storage Furniture </li>
								</ol>
						</div>
						<div class="container">
		<!--1row-->
						...
						<b> <font size="4px"> Shop by Storage Furniture</font></b>
						</div>
						</div>
						...
						<?php
								...
								echo "<div class='card' >";
									...
									echo "<div class='card-body'>";
										 ...
										 echo $name;
										echo "<br><br>";										
										 echo "<a href='productcommonpage.php?value1=$product_id & value2=storage' class='btn btn-primary'>See Full Details </a>";
										echo "</b></font>";
