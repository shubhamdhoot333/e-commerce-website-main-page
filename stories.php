		...
		<!--1row-->				
							<div class="row">
								<div class="col-lg-12 text-center">
									<b><font face="segoe script" size="6px"> Customer store</font></b>
								</div>
							</div>
						</div>
		<!--2row-->
							<?php
							$query=mysqli_query($conn,"Select * from rating where stage like 'show' ");
							...
							$n;
										...
										for($j=0;$j<3;$j++)
									{
										...
										echo "<div class='col-lg-4 text-center'>";
											echo "<div class='card p-1 ml-4' style='width: 18rem;'>";
												$roa = mysqli_fetch_array($query);
													$user=$roa['username'];
													$area=$roa['area'];
													$story=$roa['story'];
													$way=$roa['photo'];
													echo "<img src='$way' class='card-img-top' height='200px' width='200px'>";
													echo " <div class='card-body'> ";	
													echo "<p class='card-text'><font size='3px'>'' $story ''</font></p>";
													echo "<p class='card-text text-left p-1'><font size='4px'><b>$area<br>$user</b></font></p>";
