...
<body>
		...
		<!--breadcrumb-->			
						<div aria-label="breadcrumb">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Type of Wood</li>
								</ol>
						</div>
		<!--container-->
						<div class="container">
		...
		<!--1row-->				
							<div class="row">
								<div class="col-lg-12 text-center">
									<b><font face="segoe script" size="7px"> GO FOR SOLIDWOOD,<br>
										DON’T COMPROMISE WITH QUALITy</font>
									</b>
								</div>
							</div>
							</div>
		<!--2row-->
							<div class="row">
								<div class="col-lg-12 text-center">
								<h3 class="h3">Solidwood</h3>
								</div>
							</div>
		<!--3row-->			<br><br>		
							<div class="row">
								<div class="col-lg-12 text-center">
									<h4 class="h4"><label><u>*Definition</u></label></h4>
									<h6 class="h6">Solidwood is the term used to distinguish between lumber and engineered wood. 
									It is a superlative form wood that has no hollow spaces in its composition, thus being the best for furniture.</h6>
								</div>
							</div>
		<!--4row-->				<br>	
							<div class="row">
								<div class="col-lg-12 text-center">
									<h4 class="h4"><label><u>*Quality</u></label></h4>
									<h6 class="h6">High in quality and looks, solidwood constitutes to be the finest material for your home furniture.</h6>
								</div>
							</div>
		<!--5row-->			<br>	
							<div class="row">
								<div class="col-lg-12 text-center">
									<h4 class="h4"><label><u>*Durability</u></label></h4>
									<h6 class="h6">Higher durability and consistency compared to other wood varieties.</h6>
								</div>
							</div>
		<!--6row-->			<br>	
							<div class="row">
								<div class="col-lg-12 text-center">
									<h4 class="h4"><label><u>*Looks</u></label></h4>
									<h6 class="h6">Exhilarating looks and admirable grace make it a perfect wood for furniture..</h6>
								</div>
							</div>
		<!--7row-->			<br>	
							<div class="row">
								<div class="col-lg-12 text-center">
									<h4 class="h4"><label><u>*Cost</u></label></h4>
									<h6 class="h6">Comparatively costs more than engineered and veneered wood considering the quality and durability.</h6>
								</div>
							</div>
		<!--8row-->			<br>	
							<div class="row">
								<div class="col-lg-12 text-center">
									<h4 class="h4"><label><u>*Reuse</u></label></h4>
									<h6 class="h6">Products composed of solidwood can be reused at some point of time to produce new useful products.</h6>
								</div>
							</div>	
